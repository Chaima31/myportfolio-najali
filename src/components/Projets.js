...
<div className='title-content'><FaCopy style={{paddingBottom:"8px"}}/> Projets</div>
            ...
            <Card className="shadow-lg p-3 mb-5 bg-white rounded my-5 mx-auto py-4 px-4 " style={{textAlign: 'left' }}>
                <Card.Body>
                    ...
                    <ul>
                        <li>
                            <h5 class="card-text">Application de gestion de restaurants  </h5>
                        </li>
                        <br />
                        <p className='text-secondary'><strong>Technologies : </strong> Html, Css, Laravel, Laragon</p>
                    </ul>
                </Card.Body>
            </Card>
